...
- **[openclaw-monitor](https://github.com/flik2002/openclaw-monitor)** - Vue3 - Free open-source monitoring dashboard for OpenClaw AI agents — token usage, session tracking, 7-day trends, multi-model support.
